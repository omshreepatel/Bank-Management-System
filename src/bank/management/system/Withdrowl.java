...
public class Withdrowl extends JFrame implements ActionListener {
   ...
   JButton withdrowl, back;
    ...
    Withdrowl(String pinnumber){
        ...
        text = new JLabel("Enter the amount you want to withdrowl");
        ...
        withdrowl.setBounds(300, 400, 150, 30);
        ...
        if(ae.getSource()== withdrowl){ 
            ...
            if(number.equals("")){
                JOptionPane.showMessageDialog(null, "Please enter the amount to you want to Withdrowl");
                    ...
                    JOptionPane.showMessageDialog(null, "Rs. "+number+" Withdrowl Successfully");
                    setVisible(false);
